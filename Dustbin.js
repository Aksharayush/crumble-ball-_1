class  Dustbin{
    constructor(x,y){
        ...
        this.left = Bodies.rectangle(this.x-100,this.y-50,this.thickness,this.height,{isStatic:true});
        Matter.Body.setAngle(this.left,this.angle); 
        this.right = Bodies.rectangle(this.x+100,this.y-50,this.thickness,this.height,{isStatic:true});
